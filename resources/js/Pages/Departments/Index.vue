...
const deleteDepartment = (id,name) =>{
    ...
    alerta.fire({
        title:'Seguro que desea eliminar el departamento de '+name+'?',
                ...
                <table class="table-auto border border-gray-400">
                    <thead>
                        <tr class="bg-gray-100"> 
                            ...
                            <th class="px-4 py-4">DEPARTAMENT</th>
                            <th class="px-4 py-4"></th>
                            <th class="px-4 py-4"></th>
                     </tr>
                    </thead>
                    <tbody>
                        ...
                        <td class="border border-gray-400 px-4 py-4">
                            ...
                            :class="'px-4 py-2 bg-yellow-400 text-white borde rounded-md font-semibold text-xs'">
